...
class Search {
  ...
  } //3.-method: function no capital letter for remove
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(alexnaranjoData.root_url + '/wp-json/alexnaranjo/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
             <div class="row">
               <div class="one-third">
               ...
               <div class="one-third">
                ...
                ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No programs match that search.<a href="${alexnaranjoData.root_url}/programs">See all programs</a></p>`}
               ...
               <div class="one-third">
                 <h2 class="search-overlay__section-title">Campusses</h2>
                 ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campuses match that search.<a href="${alexnaranjoData.root_url}/campuses">See all campuses</a></p>`}
                 ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
                ${results.campuses.length ? '</ul>' : ''} 
                 <h2 class="search-overlay__section-title">Events</h2>
                 <h2 class="search-overlay__section-title">Campusses</h2>
                 ${results.events.length ? '' : `<p>No events match that search.<a href="${alexnaranjoData.root_url}/events">See all events</a></p>`}
