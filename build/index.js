...
console.log('test javascript: Author: Alex Naranjo');
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(alexnaranjoData.root_url + "/wp-json/alexnaranjo/v1/search?term=" + this.searchField.value);
      ...
      this.resultsDiv.innerHTML = `
        <div class="row">
          ...
          <div class="one-third">
            ...
            ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No programs match that search. <a href="${alexnaranjoData.root_url}/programs">View all programs</a></p>`}
          ...
          <div class="one-third">
            ...
            ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campuses match that search. <a href="${alexnaranjoData.root_url}/campuses">View all campuses</a></p>`}
              ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
            ${results.campuses.length ? "</ul>" : ""}

            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length ? "" : `<p>No events match that search. <a href="${alexnaranjoData.root_url}/events">View all events</a></p>`}
